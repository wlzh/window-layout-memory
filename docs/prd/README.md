...
| 目标版本 | 状态 | 文档 | 发布状态 |
| --- | --- | --- | --- |
| v0.3.0-preview.9 | 已对齐边保持、授权事件恢复 | [PRD](v0.3.0-preview.9/prd.md)、[设计](v0.3.0-preview.9/design.md)、[技术](v0.3.0-preview.9/dev.md)、[计划](v0.3.0-preview.9/plan.md) | build 13；实测见总览 |
