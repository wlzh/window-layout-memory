...
build 25历史明暗外观（build 26沿用布局，版本文本更新）：

![当前浅色关于窗口](assets/about-build25-light.png)
![当前深色关于窗口](assets/about-build25-dark.png)

v0.3.0-preview.18 / build 25，2026-09-12。关于功能始于preview.2；本版改用正式应用图标并保持方形比例；菜单栏仍为单色符号。旧截图仅作历史外观参考，当前图标见[图标说明](APP_ICON.md)。
