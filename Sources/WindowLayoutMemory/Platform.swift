...
static var build: String { Bundle.main.object(forInfoDictionaryKey:"CFBundleVersion") as? String ?? "27" }
static var channel: String { Bundle.main.object(forInfoDictionaryKey:"WLMReleaseChannel") as? String ?? "preview.20" }
