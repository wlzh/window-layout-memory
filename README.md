...
build 10加入持久化“横屏铺满排除应用”，支持运行列表及文件选择.app；另增加尺寸受同屏边界限制时的一次非全屏原生缩放回退，保留先核验尺寸再对齐的保护。真实应用兼容性与发布状态见[状态总览](docs/STATUS.md)。
...
详见 [使用指南](docs/USER_GUIDE.md)、[测试报告](docs/TESTING.md)、[兼容性](docs/COMPATIBILITY.md)、[发行说明](docs/releases/v0.3.0-preview.6.md)。
